...
public class ProductDAOImpl extends AbstractDaoImpl implements ProductDAO {
	...
	public String listProduct() {
		...
		List<Product> productList=getCurrentSession().createQuery("from Product").getResultList();
		//return categoryList;
	...
	public Product getById(int productId) {
		...
		@SuppressWarnings({  "unchecked" })
		List<Product> productList=getCurrentSession().createQuery(editQuery).getResultList();
	...
	public void delete(int productId) {
		...
		getCurrentSession().delete(removeProduct);
	...
	public Product getByName(String productName)
	{
		...
		@SuppressWarnings({  "unchecked" })
		List<Product> productsList=getCurrentSession().createQuery(editQuery).getResultList();
	...
	{
		@SuppressWarnings({  "unchecked" })
		List<ProductView> productViewList=getCurrentSession().createQuery("from ProductView").getResultList();
	...
	public ProductView getProductViewById(int productId)
	{
		...
		@SuppressWarnings({  "unchecked" })
		List<ProductView> productViewList=getCurrentSession().createQuery(editQuery).getResultList();
